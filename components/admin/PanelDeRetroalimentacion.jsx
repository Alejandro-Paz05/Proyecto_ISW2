 ...
 *
 * Se llega desde los dos portales, y por eso el portal llega como prop: es lo
 * que dicen las clientas del negocio —lo primero que le interesa a la dueña— y
 * a la vez el origen de los tickets que ve quien corrige. Cada portal tiene su
 * propia página, las dos apuntando acá, para que nadie termine mudado al otro
 * portal por tocar una sección de la barra.
 */
...
export default function PanelDeRetroalimentacion({ sesion, portal = 'tienda' }) {
  ...
  return (
    <AdminLayout titulo="Retroalimentación" portal={portal} sesion={sesion}>
