...
/**
 * La galería cambia cuando la dueña sube una foto, y entonces quiere verla en
 * la portada ya. Con las cabeceras de las categorías tardaba entre cinco y
 * quince minutos en aparecer, y desde afuera eso se ve como que no se guardó.
 *
 * `public` porque no hay nada privado y el CDN puede guardarla; `no-cache`
 * porque tiene que preguntar antes de servirla. El ETag hace que esa pregunta
 * cueste un 304 y no la lista entera.
 */
export const CACHE_GALERIA = 'public, no-cache, must-revalidate';
